...
final class Validity
{
     ...
     *
     * @param null|string $nbDate Not before date
     * @param null|string $naDate Not after date
     * @param null|string $tz Timezone string
     */
    public static function fromStrings(?string $nbDate, ?string $naDate, ?string $tz = null): self
    {
        return self::create(Time::fromString($nbDate, $tz), Time::fromString($naDate, $tz));
    }
