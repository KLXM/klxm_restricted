    ...
    public static function mb_str_pad(string $string, int $length, string $padString = ' ', int $padType = \STR_PAD_RIGHT, ?string $encoding = null): string
    {
        ...
        switch ($padType) {
            ...
            default:
                ...
                return mb_substr(str_repeat($padString, $leftPaddingLength), 0, $leftPaddingLength, $encoding).$string.mb_substr(str_repeat($padString, $rightPaddingLength), 0, $rightPaddingLength, $encoding);
        }
    }
