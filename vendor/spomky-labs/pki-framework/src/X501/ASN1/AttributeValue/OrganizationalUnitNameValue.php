...
{
    public static function create(string $value, int $stringTag = DirectoryString::UTF8): static
    {
        return new static(AttributeType::OID_ORGANIZATIONAL_UNIT_NAME, $value, $stringTag);
    }
}
