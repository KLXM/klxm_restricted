...
final class Length implements Encodable
{
     ...
     * Length.
     */
    private readonly BigInt $length;
    ...
    private function __construct(
        ...
        private readonly bool $indefinite = false
    ) {
        $this->length = BigInt::create($length);
    }

    public static function create(BigInteger|int $length, bool $indefinite = false): self
    {
