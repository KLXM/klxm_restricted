...
abstract class RFC8410PrivateKey extends PrivateKey
{
     ...
     */
    protected int $_version = OneAsymmetricKey::VERSION_2;
     ...
     * @param null|string $publicKeyData Public key data
     */
    protected function __construct(protected string $privateKeyData, protected ?string $publicKeyData = null)
    {
    }
