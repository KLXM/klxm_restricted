...
final class Sequence extends Structure
{
     ...
     */
    private static function decodeDefiniteLength(string $data, int &$offset, int $length): self
    {
        $idx = $offset;
        $end = $idx + $length;
        $elements = [];
     ...
     * @param int $offset Offset to data
     */
    private static function decodeIndefiniteLength(string $data, int &$offset): self
    {
        $idx = $offset;
        $elements = [];
