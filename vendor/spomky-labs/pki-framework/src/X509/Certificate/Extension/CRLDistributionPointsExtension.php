...
class CRLDistributionPointsExtension extends Extension implements Countable, IteratorAggregate
{
    ...
    public static function create(bool $critical, DistributionPoint ...$distributionPoints): self
    {
        return new self(self::OID_CRL_DISTRIBUTION_POINTS, $critical, ...$distributionPoints);
    }
