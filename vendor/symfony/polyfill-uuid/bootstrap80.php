...
if (!function_exists('uuid_create')) {
    function uuid_create(?int $uuidType = \UUID_TYPE_DEFAULT): string { return p\Uuid::uuid_create((int) $uuidType); }
}
if (!function_exists('uuid_generate_md5')) {
    function uuid_generate_md5(?string $uuidNs, ?string $name): string { return p\Uuid::uuid_generate_md5((string) $uuidNs, (string) $name); }
}
if (!function_exists('uuid_generate_sha1')) {
    function uuid_generate_sha1(?string $uuidNs, ?string $name): string { return p\Uuid::uuid_generate_sha1((string) $uuidNs, (string) $name); }
}
