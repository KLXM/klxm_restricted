...
final class PathValidationConfig
{
     ...
     * @var string[]
     */
    private array $policySet = [PolicyInformation::OID_ANY_POLICY];
     ...
     */
    private bool $anyPolicyInhibit = false;
