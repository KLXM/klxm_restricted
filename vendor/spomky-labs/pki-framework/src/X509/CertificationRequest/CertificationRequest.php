...
final class CertificationRequest implements Stringable
{
    ...
    public static function create(
        ...
        return new self($certificationRequestInfo, $signatureAlgorithm, $signature);
    }
    ...
    public function verify(?Crypto $crypto = null): bool
    {
        ...
        $data = $this->certificationRequestInfo->toASN1()
            ->toDER();
        $pkInfo = $this->certificationRequestInfo->subjectPKInfo();
        return $crypto->verify($data, $this->signature, $pkInfo, $this->signatureAlgorithm);
    }
}
