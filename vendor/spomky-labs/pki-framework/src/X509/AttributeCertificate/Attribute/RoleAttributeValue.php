...
final class RoleAttributeValue extends AttributeValue
{
     ...
     *
     * @param string $roleName Role name in URI format
     * @param null|GeneralNames $authority Issuing authority
     */
    public static function fromString(string $roleName, ?GeneralNames $authority = null): self
    {
        return self::create(UniformResourceIdentifier::create($roleName), $authority);
    }
