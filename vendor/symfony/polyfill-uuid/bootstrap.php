...
if (!function_exists('uuid_create')) {
    function uuid_create($uuidType = \UUID_TYPE_DEFAULT) { return p\Uuid::uuid_create($uuidType); }
}
if (!function_exists('uuid_generate_md5')) {
    function uuid_generate_md5($uuidNs, $name) { return p\Uuid::uuid_generate_md5($uuidNs, $name); }
}
if (!function_exists('uuid_generate_sha1')) {
    function uuid_generate_sha1($uuidNs, $name) { return p\Uuid::uuid_generate_sha1($uuidNs, $name); }
}
