...
final class ObjectIdentifier extends Element
{
     ...
     */
    private static function explodeDottedOID(string $oid): array
    {
        $subids = [];
        if ($oid !== '') {
     ...
     */
    private static function implodeSubIDs(BigInteger ...$subids): string
    {
     ...
     */
    private static function encodeSubIDs(BigInteger ...$subids): string
    {
        $data = '';
     ...
     * @return BigInteger[] Array of BigInteger numbers
     */
    private static function decodeSubIDs(string $data): array
    {
        $subids = [];
        $idx = 0;
