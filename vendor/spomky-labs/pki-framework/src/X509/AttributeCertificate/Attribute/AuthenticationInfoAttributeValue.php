...
final class AuthenticationInfoAttributeValue extends SvceAuthInfo
{
    ...
    public static function create(GeneralName $service, GeneralName $ident, ?string $authInfo = null): self
    {
        return new self($service, $ident, $authInfo);
    }
    ...
    public static function fromASN1(UnspecifiedType $el): static
    {
        ...
        return self::create($service, $ident, $authInfo);
    }
}
