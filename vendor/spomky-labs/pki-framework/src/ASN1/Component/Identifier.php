...
final class Identifier implements Encodable
{
    ...
    {
        $this->class = 0b11 & $class;
        $this->pc = 0b1 & $pc;
        $this->tag = BigInt::create($tag);
    }
    ...
    {
        return $this->class === self::CLASS_UNIVERSAL;
    }
    ...
    {
        return $this->class === self::CLASS_APPLICATION;
    }
    ...
    {
        return $this->class === self::CLASS_CONTEXT_SPECIFIC;
    }
    ...
    {
        return $this->class === self::CLASS_PRIVATE;
    }
    ...
    {
        return $this->pc === self::CONSTRUCTED;
    }
