...
final class CertificationPath implements Countable, IteratorAggregate
{
     ...
     * @param CertificateBundle $trustAnchors List of trust anchors
     * @param null|CertificateBundle $intermediate Optional intermediate certificates
     */
    public static function toTarget(
        Certificate $target,
        CertificateBundle $trustAnchors,
        ?CertificateBundle $intermediate = null
    ): self {
        return CertificationPathBuilder::create($trustAnchors)->shortestPathToTarget($target, $intermediate);
    }
    ...
    public static function fromTrustAnchorToTarget(
        ...
        return self::toTarget($target, CertificateBundle::create($trustAnchor), $intermediate);
    }
